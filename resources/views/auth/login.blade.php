                ...
                <div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <input type="email" id="email" required name="email" placeholder="info@gmail.com" value="{{ old('email') }}"
                            ...
                            <div class="flex items-center justify-between">
                                <a href="/forgot-password"
                                    class="text-gray-700 hover:text-brand-400 dark:text-brand-400 text-sm">
                                    Forgot password?
                                </a>
                            </div>
                            <!-- Button -->
                    ...
                    <div class="mt-5">
                        <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                            ...
                            <a href="/register" class=" hover:text-brand-400">

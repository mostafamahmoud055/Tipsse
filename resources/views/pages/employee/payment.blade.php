...
amountBtns.forEach(btn => {
    btn.addEventListener('click', () => {
        amountBtns.forEach(b => {
            b.classList.remove('ring-2', 'ring-green-500', 'dark:ring-green-400', 'border-green-500', 'dark:border-green-400', 'bg-green-50', 'dark:bg-green-900/20');
        });
        btn.classList.add('ring-2', 'ring-green-500', 'dark:ring-green-400', 'border-green-500', 'dark:border-green-400', 'bg-green-50', 'dark:bg-green-900/20');

...
@php
    $selectedDate = old($name, $value ?? $defaultDate);
@endphp
...
defaultDate: {!! $selectedDate
    ...
    <div class="relative custom-datepicker">
        ...
        {{-- Calendar Icon --}}
        <span class="absolute text-gray-500 -translate-y-1/2 pointer-events-none right-10 top-1/2 dark:text-gray-400 px-1">
        ...
        <button type="button"
            @click="reset()"
            class="absolute  right-3 top-1/2 -translate-y-1/2 text-xs text-gray-800 dark:text-white/90 font-medium">
            Reset
        </button>
    </div>
</div>

    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img class="dark:hidden" src="/images/logo/auth-logo.png" alt="Logo" width="50"
                    height="50" />
                <img class="hidden dark:block" src="/images/logo/auth-logo.png" alt="Logo" width="50"
                    height="50" />
                <span class=" text-lg font-semibold text-gray-800 dark:text-white/90"> {{ config('app.name') }}</span>
            </a>
            ...
            <x-form.search.search class="hidden xl:block ml-4" hideButton=false
                placholder="Search or type command..." />

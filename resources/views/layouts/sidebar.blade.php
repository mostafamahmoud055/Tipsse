    ...
    <div class=" flex"
        ...
        <a href="/" class="flex items-center ">
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class=" pt-2 dark:hidden" src="/images/logo/auth-logo.png" alt="Logo" width="70"
                height="40" />
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class=" pt-2 hidden dark:block" src="/images/logo/auth-logo.png" alt="Logo" width="70"
                height="40" />
            <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                            ...
                            @foreach ($menuGroup['items'] as $itemIndex => $item)
                                <li>
                                    ...
                                    @else
                                        ...
                                        @else
                                            <form class="flex gap-2 m-4 px-1" method="POST"
                                                action="{{ route('logout') }}">
                                                @csrf
                                                ...
                                                <button
                                                    x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                                                    class=" flex items-center gap-2 dark:text-white/90"
                                                    type="submit">{{ $item['name'] }}</button>
                                            </form>
